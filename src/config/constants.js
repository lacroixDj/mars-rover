 ...
 * 0 = Off
 * 1 = Custom validation errors 
 * 2 = Custom  validation erros + Stack trace 
 *  
*/ 

const ERROR_REPORTING = 1;
...
// This a bidirectional map which allows to find a cardinal point either by label or value
CARDINAL_POINTS = new Map ([
    
    [ NORTH.LABEL, NORTH ]  ,  [ NORTH.VALUE, NORTH ],

    [ WEST.LABEL, WEST ]    ,  [ WEST.VALUE, WEST ], 
    
    [ SOUTH.LABEL, SOUTH ]  ,  [ SOUTH.VALUE, SOUTH ], 
    
    [ EAST.LABEL, EAST ]    ,  [ EAST.VALUE, EAST ]
]); 
 ...
 * Rotate commands
 * 
 * Literal inputs commands labels that indicates
 * when robot must turn to left or right.
 * 
*/ 
const ROTATE_LEFT   =  'L';
