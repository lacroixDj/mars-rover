...
class Robot {
    ...
    constructor(postion_x, postion_y, orientation, lost){
    ...
    */
    checkIfLost(limit_x, limit_y, position_x, position_y) {
        ...
        let position_x = position_x || this._postion_x;

        let position_y = position_y || this._postion_y;

        lost_in_x = position_x < 0  || position_x >= limit_x;

        lost_in_y = position_y < 0  || position_y >= limit_y;
